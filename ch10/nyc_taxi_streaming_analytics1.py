...
def run(argv=None, save_main_session=True):
    ...
    parser.add_argument(
        "--output_dataset",
        required=True,
        help=('Output BigQuery dataset "<PROJECT>.<DATASET>.<TABLE>"'),
    )
    ...
    with beam.Pipeline(options=pipeline_options) as p:
        ...
        (bigquery_project, dataset, table) = known_args.output_dataset.split(".")
        ...
        rides_onoff = rides | "Filter pickup/dropoff" >> beam.Filter(
            is_pickup_or_dropoff
        )
